...
export default function QuotationForm() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await axios.post("/api/quotation", formData, {
        ...
        <div className="py-16 bg-blue-50 dark:bg-gray-900 dark:border-t-6">
            <div className="max-w-4xl mx-auto px-6 lg:px-8">
                ...
                <form
                    ...
                    className="mt-8 space-y-6 bg-white dark:bg-gray-900 dark:text-red p-6 rounded-md shadow-md"
                >
                    <div>
                    ...
                    <div>
                        <label htmlFor="package" className="block text-sm font-medium text-gray-700 dark:text-white">
                            Package Type
                        </label>
                        <select
                            id="package"
